...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('front/assets/images/logoamdep.png')}}" />

    <!-- FontAwesome JS-->
    <script defer src="{{asset('front/assets/plugins/fontawesome/js/all.min.js')}}"></script>

    <!-- App CSS -->
    <link id="theme-style" rel="stylesheet" href="{{asset('front/assets/css/portal.css')}}" />
      ...
      <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
          ...
          <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2 mr-2" src="{{asset('front/assets/images/logoamdep.png')}}" alt="logo" /><span class="logo-text">AMDEP</span></a>
          </div>
          <!--//app-branding-->
